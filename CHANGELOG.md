...
В режиме похожих в колонке цены — зелёный «лучший» / оранжевый «+N%» относительно минимума в отфильтрованном наборе. Диски сравниваем отдельно по ёмкости и по IOPS (NVMe GiB ≠ IOPS add-on). У K8s find-similar учитывает форму мастера (vCPU/RAM).
