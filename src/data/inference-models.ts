...
export const INFERENCE_MODELS: InferenceModelProfile[] = [
    ...
    recommended: [
      {
        ...
        notes: 'Minimum: NVFP4/INT4 ~450 GiB на 4×H200 (564 GB). FP8 на 4× не помещается.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 8,
        ...
        notes: 'Recommended FP8 (~743 GiB весов) на 8×H200.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 8,
        ...
        notes: 'High-throughput / длинный ctx + высокая concurrency на INT4.',
      },
    ],
  ...
  },
  {
    ...
    parameterCountNote: 'MoE ~357B / ~32B active. FP8 checkpoint ≈330 GB — не путать с AWQ ~176 GB.',
    weights: [
    ...
    recommended: [
      {
        ...
        notes: 'Recommended FP8: ~330 GiB весов. 2×H200 (282 GB) для FP8 недостаточно.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
      ...
      },
      {
        ...
        notes: 'AWQ/INT4 ~180 GiB — экономный single-node путь.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'FP8 ≈330 GiB; 4×H100 80GB (320) — впритык/не хватает под KV.',
    ...
    recommended: [
      {
        ...
        quant: 'int4',
        estimatedVramGiB: 24,
        notes: 'Minimum: INT4 на L4 — бюджетный single-GPU путь.',
      },
      {
        gpuFamily: 'L40S',
        gpuCount: 1,
        quant: 'fp8',
        estimatedVramGiB: 48,
        notes: 'Recommended FP8 на 48 GB.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'bf16',
        estimatedVramGiB: 80,
        notes: 'BF16 на A100 80GB + умеренный контекст/concurrency.',
      },
    ],
  ...
  },
  {
    ...
    recommended: [
      ...
      },
      {
        ...
        quant: 'fp8',
        estimatedVramGiB: 43,
        notes: 'Recommended FP8 — нормальный запас под KV/batch.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        ...
        estimatedVramGiB: 76,
        notes: 'BF16 на A100 80GB — low concurrency (~70 GiB весов + ~10 GiB запас).',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'МоE: веса всех экспертов в VRAM, active params влияют на compute.',
      '1×A100 BF16 — не просторный production primary; для API лучше L40S FP8.',
    ],
    confidence: 'high',
  },
  {
    ...
    recommended: [
      {
        ...
        quant: 'int4',
        estimatedVramGiB: 80,
        notes: 'Minimum: GPTQ-INT4 на 1×H100 80GB; KV/concurrency ограничены.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 2,
        ...
        notes: 'Recommended: официальный FP8 checkpoint, native FP8 Tensor Cores.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 2,
        ...
        notes: 'INT8 — помещается; throughput ниже H100 (нет native FP8 Tensor Cores).',
      },
    ],
    ...
    caveats: [
      ...
      'BF16 (~245 GiB весов) на 2×A100/H100 не предлагаем — нужен FP8/INT8/INT4.',
  ...
  },
  {
    ...
    parameterCountNote: '235B total / ~22B active. FP8 ≈235 GiB весов (все эксперты).',
    weights: [
    ...
    recommended: [
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'Minimum: GPTQ/INT4 ~120 GiB.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 2,
        ...
        notes: 'FP8 ~235 GiB на 2×H200 — экономичный FP8; запас под KV скромный.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 4,
        ...
        notes: 'Recommended FP8 (vLLM TP=4) с нормальным запасом.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'Не занижать FP8 до ~140 GiB — это ближе к INT4/5, не к полному FP8.',
  ...
  },
  {
    ...
    parameterCountNote: '480B total / ~35B active. FP8 ≈480 GiB весов.',
    weights: [
    ...
    recommended: [
      {
        ...
        notes: 'Minimum FP8: ~480 GiB весов на 4×H200 (564 GB) — плотная упаковка.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
        ...
        notes: 'Альтернативный FP8 на 8×H100.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 8,
        ...
        notes: 'High-throughput / длинный ctx + высокая concurrency — не «обычный запас».',
      },
    ],
  ...
  },
  {
    ...
    activeParameterCountB: 32,
    parameterCountNote:
      '~1T total / ~32B active. Native FP8 ≈550–1000 GiB в зависимости от checkpoint; INT4 ~300 GiB.',
    weights: [
    ...
    recommended: [
      {
        ...
        notes: 'Minimum: INT4 ~300 GiB на 4×H200 с умеренным запасом.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
        ...
        notes: 'INT4 на 8×H100 — альтернативный single-node floor.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 8,
        ...
        estimatedVramGiB: 700,
        notes:
          'FP8 minimum / low–medium concurrency (~550 GiB весов на 1128 GB). Официально для 128K часто 16×GPU.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      '8×H200 FP8 — почти предельная упаковка, не комфортный high-batch primary.',
      'Официальный floor FP8+128K — 16×GPU.',
  ...
  },
  {
    ...
    parameterCountNote:
      'V4 Flash: 284B total / 13B active, 1M ctx. VRAM = все 284B эксперты, не active. Native FP4+FP8 ~158 GB; MIT.',
    weights: [
      {
        dtype: 'int4',
        weightFormat: 'nvfp4',
    ...
    recommended: [
      {
        ...
        notes:
          'Minimum: native FP4+FP8 mixed / INT4 checkpoint. Наивный 284B×1B неверен — смотрите card size.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 4,
        ...
        notes:
          'Recommended: Flash-Base / FP8 Mixed checkpoint (~284 GiB) + runtime на 4×80 GB — не «любой FP8».',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 4,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 240,
        notes: 'Только INT8/INT4 — не BF16 и не полный FP8 без запаса.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'VRAM считает все 284B параметров; 13B active — только compute.',
      '2×H200 ≈282 GB: INT4/FP4 или offload; FP8 — от 4×H100/H200 с конкретным checkpoint.',
  ...
  },
  {
    ...
    parameterCountNote:
      '671B main + ~14B MTP ≈685B on disk. FP8 ≈685 GiB весов — не ~350 (это класс AWQ/INT4).',
    weights: [
      {
        dtype: 'fp8',
        weightFormat: 'fp8',
    ...
    recommended: [
      {
        ...
        notes: 'Recommended FP8: ~685 GiB весов. 4×H200 / 8×H100 80GB для FP8 не предлагаем.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 4,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 420,
        notes: 'INT4 topology на 4×H200 — другой perf-профиль vs 8×H100.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 420,
        notes: 'AWQ/INT4 ~350 GiB на 8×H100.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'FP8 ≈685 GiB; 8×H100 SXM 80GB (640) — веса не влезают комфортно.',
      'Официальные serving recipes часто multi-node при длинном ctx.',
    ],
    confidence: 'high',
  },
  {
    ...
    recommended: [
      {
        ...
        notes: 'Recommended FP8; для длинного CoT запас по KV критичен.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 4,
      ...
      },
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 420,
        notes: 'INT4 на 8×H100 — альтернативная topology.',
      },
    ],
    ...
    caveats: [
      ...
      'FP8 ≈685 GiB — 4×H200 (564) / 8×H100 80GB (640) для FP8 недостаточно.',
    ],
    confidence: 'high',
  },
  {
  ...
  },
  {
    ...
    parameterCountNote:
      'MoE 116.8B total / 5.1B active. Native MXFP4 MoE weights — checkpoint ≈61 GiB.',
    weights: [
      {
        dtype: 'int4',
        weightFormat: 'int4',
    ...
    recommended: [
      {
        ...
        estimatedVramGiB: 80,
        notes:
          'Primary: официальный MXFP4 checkpoint на 1×H100 80GB — 8×GPU не нужны.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 1,
        ...
        notes: 'Тот же MXFP4 checkpoint на 1×H200 — запас под длинный ctx / batch.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        ...
        estimatedVramGiB: 80,
        notes:
          'Third-party INT4 / compatible runtime: у A100 нет native MXFP4 Tensor Cores.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'Не берите 8×H100 «на всякий случай» — при MXFP4 это избыточно.',
      'FP8 не основной официальный формат — только при проверенной конверсии.',
      'BF16 всех экспертов ~234 GiB — на одной карте не влезает.',
    ],
    confidence: 'high',
  },
  {
    ...
    parameterCountNote: 'MoE 20.9B total / 3.6B active. Native MXFP4 checkpoint ≈13 GiB.',
    weights: [
      {
        dtype: 'int4',
        weightFormat: 'int4',
    ...
    recommended: [
      {
        ...
        estimatedVramGiB: 24,
        notes:
          'MXFP4 weights помещаются в 24 GB; у L4 нет native MXFP4 Tensor Cores — perf зависит от runtime/dequant.',
      },
      {
        gpuFamily: 'L40S',
        gpuCount: 1,
        quant: 'fp8',
        estimatedVramGiB: 40,
        notes: 'FP8 conversion checkpoint (не native MXFP4 path).',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'bf16',
        estimatedVramGiB: 80,
        notes: 'BF16 с запасом под контекст.',
      },
    ],
    ...
    caveats: [
      ...
      'L4: вместимость OK; не путать с аппаратно ускоренным MXFP4 на Hopper/Blackwell.',
    ],
    confidence: 'high',
  },
  {
  ...
  },
  {
    ...
    parameterCountB: 31,
    parameterCountNote:
      'Dense multimodal (~30.7B; HF может показывать ~33B). Apache 2.0. Family also has 26B-A4B MoE.',
    weights: [
    ...
    recommended: [
      {
        ...
        quant: 'int4',
        estimatedVramGiB: 23,
        notes: 'Minimum: INT4 / GPTQ / AWQ / GGUF Q4 на 24 GB.',
      },
      {
        gpuFamily: 'L40S',
        gpuCount: 1,
        quant: 'fp8',
        estimatedVramGiB: 43,
        notes: 'Recommended FP8/INT8 на 48 GB.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'bf16',
        estimatedVramGiB: 80,
        notes: 'BF16 на A100 80GB (~62 GiB весов + KV).',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'Формат весов обязателен: L4→INT4, L40S→FP8/INT8, A100→BF16.',
    ...
    recommended: [
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 320,
        notes: 'Primary INT4 (~200–240 GiB весов) — tightly packed, зависит от quant checkpoint.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 2,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 282,
        notes: 'Low-concurrency INT4 на 2×H200 (282 GB) — ещё плотнее.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 640,
        notes: 'Recommended FP8: цельный 8×H100 host (model card).',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 4,
  ...
  },
  {
    ...
    recommended: [
      ...
      },
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'BF16 ~140 GiB на 2×H100 — moderate context/concurrency.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 2,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'BF16 на 2×A100 — moderate context.',
      },
    ],
  ...
  },
  {
    ...
    recommended: [
      {
        ...
        notes: 'Recommended INT4 на 2×A100 — разумный commercial primary.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 2,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'FP8 ~145 GiB на 2×H100 — low-concurrency minimum (мало запаса под KV).',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'int4',
        estimatedVramGiB: 80,
        notes: 'Experimental: batch=1 / короткий ctx; не устойчивый API floor.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'BF16 (~280 GiB) — от 4×A100/H100; в рецептах ниже не предлагаем.',
      '1×A100 INT4 — experimental, не production API.',
    ],
    confidence: 'high',
  },
  {
    ...
    recommended: [
      {
        ...
        quant: 'int4',
        estimatedVramGiB: 24,
        notes: 'Minimum: INT4 — бюджетный local agent path.',
      },
      {
        gpuFamily: 'L40S',
        gpuCount: 1,
        quant: 'fp8',
        estimatedVramGiB: 40,
        notes: 'Recommended FP8 на 48 GB для agent coding.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'bf16',
        estimatedVramGiB: 80,
        notes: 'BF16 на A100 80GB — запас под длинный agent ctx.',
      },
    ],
  ...
  },
  {
    ...
    recommended: [
      {
        ...
        quant: 'bf16',
        estimatedVramGiB: 24,
        notes: 'Minimum: BF16 (~16 GiB весов) на L4 24GB. Длинный ctx / high batch → FP8/INT8.',
      },
      {
        gpuFamily: 'L40S',
        gpuCount: 1,
        quant: 'bf16',
        estimatedVramGiB: 48,
        notes: 'Recommended для concurrency / длинного контекста.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'bf16',
        estimatedVramGiB: 40,
        notes: 'Запас под batching и 128K+ ctx.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'Enterprise-first SLM; не frontier chat, зато дешёвый self-host и permissive license.',
  ...
  },
  {
    ...
    parameterCountNote:
      '~428B total / ~23B active, native multimodal (text/image/video), 1M ctx via MSA. FP8 ≈428 GiB весов.',
    weights: [
    ...
    recommended: [
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 520,
        notes: 'Minimum FP8: ~430 GiB весов на 4×H200 (564 GB).',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 520,
        notes: 'Recommended FP8 на 8×H100. BF16 (~856 GiB) на 8×H100 не помещается.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 8,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 600,
        notes: 'High-throughput / длинный 1M ctx + высокая concurrency.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'Рецепты ниже — FP8 only. BF16 требует ~856 GiB только под веса.',
      'NVFP4 (~256 GB) — Blackwell (B200); не смешиваем с H100-рецептами.',
  ...
  },
  {
    ...
    parameterCountNote:
      'LatentMoE hybrid (Mamba-2 + MoE + attn), 120B / 12B active, up to 1M ctx. NVFP4 — Blackwell-native.',
    weights: [
    ...
    recommended: [
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'Minimum на Hopper: FP8 (~120 GiB весов). NVFP4 на H100 не указываем.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 4,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 320,
        notes: 'Recommended BF16: полный footprint всех экспертов на 4×H100.',
      },
      {
        gpuFamily: 'B200',
        gpuCount: 2,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'NVFP4 на Blackwell (2×B200). В РФ-каталоге B200 может быть без публичной цены.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'NVFP4 — нативный формат Blackwell (B200/GB200), не H100/H200.',
