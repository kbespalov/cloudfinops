...
export const INFERENCE_MODELS: InferenceModelProfile[] = [
  ...
  },
  {
    ...
    recommended: [
      ...
      },
      {
        ...
        notes: 'INT8/INT4 only — не BF16. У A100 нет native FP8 Tensor Cores, throughput ниже H100.',
      },
    ],
    ...
    recommended: [
      {
        ...
        notes: 'Official FP8 path (vLLM TP=4). Runtime+KV ~270–300 GiB.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 2,
        ...
        notes: '2×H200 (282 GB) — FP8 впритык; длинный ctx лучше на 4×.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 2,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'GPTQ/INT4 ~120 GiB — minimum single-node.',
      },
    ],
    ...
    recommended: [
      {
        ...
        notes: 'FP8 ~480 GiB + runtime на 8×80 GB.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 4,
        ...
        notes: '4×H200 (564 GB) — FP8 впритык; для длинного ctx лучше 8×H200.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 8,
        ...
        notes: 'Запас под KV / concurrency.',
      },
    ],
  ...
  },
  {
    ...
    activeParameterCountB: 32,
    parameterCountNote:
      '~1T total / ~32B active. Native FP8 checkpoint ≈550 GiB resident weights.',
    weights: [
    ...
    recommended: [
      {
        ...
        estimatedVramGiB: 700,
        notes:
          'Практичный single-node FP8 (~550 GiB весов на 8×H200). Официально для 128K Moonshot часто указывает 16×GPU.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
        ...
        notes: 'INT4 на 8×H100 — нижняя полка; FP8 на 8×H100 80GB не помещается.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'Официальный floor FP8+128K — 16×GPU; 8×H200 — pragmatic short-ctx / tuned serving.',
  ...
  },
  {
    ...
    recommended: [
      {
        ...
        notes:
          'Minimum: native FP4+FP8 / INT4. FP8 (~284 GiB весов) на 2×H200 не помещается без offload.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 4,
        ...
        notes: 'Recommended FP8: ~284 GiB весов + runtime на 4×80 GB.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 4,
    ...
    caveats: [
      ...
      '2×H200 ≈282 GB: INT4/FP4 или offload; FP8 — от 4×H100/H200.',
  ...
  },
  {
    ...
    recommended: [
      ...
      },
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 420,
        notes: 'Minimum single-node: AWQ/INT4 ~350 GiB на 8×H100.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 4,
    ...
    recommended: [
      {
        ...
        notes: 'FP8 full R1; для длинного CoT запас по KV критичен — не 4×H200.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 8,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 420,
        notes: 'AWQ/INT4 single-node floor на 8×H100.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 4,
    ...
    recommended: [
      {
        ...
        estimatedVramGiB: 80,
        notes:
          'Базовый path: native MXFP4 на 1×H100 80GB — 8×GPU не нужны.',
      },
      {
        gpuFamily: 'H200',
        gpuCount: 1,
        quant: 'fp8',
        estimatedVramGiB: 141,
        notes: '1×H200 — запас под dequant FP8 / длинный ctx без второго GPU.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'int4',
        estimatedVramGiB: 80,
        notes: '1×A100 80GB MXFP4/INT4 — дешевле H100 при меньшем throughput.',
      },
      {
        gpuFamily: 'H100',
        gpuCount: 2,
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'FP8/больший batch без агрессивной 4-bit.',
      },
    ],
    ...
    recommended: [
      {
        ...
        quant: 'int4',
        estimatedVramGiB: 24,
        notes: 'OpenAI: ~16 GB path — MXFP4 на L4.',
      },
      {
        gpuFamily: 'L40S',
        gpuCount: 1,
  ...
  },
  {
    ...
    recommended: [
      {
        ...
        quant: 'bf16',
        estimatedVramGiB: 80,
        notes: 'Recommended: BF16 на A100 80GB (~62 GiB весов + KV).',
      },
      {
        gpuFamily: 'L40S',
        gpuCount: 1,
        quant: 'fp8',
        estimatedVramGiB: 43,
        notes: 'FP8/INT8 на 48 GB — BF16 на L40S не предлагаем.',
      },
      {
        gpuFamily: 'L4',
        gpuCount: 1,
        quant: 'int4',
        estimatedVramGiB: 23,
        notes: 'Minimum: только INT4 / GPTQ / AWQ / GGUF Q4 на 24 GB.',
      },
    ],
    ...
    checkedAt: '2026-07-27',
    caveats: [
      'Формат весов обязателен: A100→BF16, L40S→FP8/INT8, L4→INT4.',
    ...
    recommended: [
      {
        ...
        interconnect: 'NVLink',
        estimatedVramGiB: 160,
        notes: 'FP8 ~145 GiB на 2×H100 — комфортно с умеренным KV.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 2,
        ...
        notes: 'INT4 на 2×A100 (не FP8 — у A100 нет native FP8 Tensor Cores).',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
        quant: 'int4',
        estimatedVramGiB: 80,
        notes: 'Minimum INT4; KV/concurrency ограничены.',
      },
    ],
    hostedCatalogKeys: ['Mixtral', 'mixtral'],
    sources: ['Mistral Mixtral 8x22B model card'],
    checkedAt: '2026-07-27',
    caveats: ['BF16 (~280 GiB) — от 4×A100/H100; в рецептах ниже не предлагаем.'],
    confidence: 'high',
  },
  {
    ...
    recommended: [
      {
        ...
        quant: 'fp8',
        estimatedVramGiB: 40,
        notes: 'FP8 на 48 GB — BF16 (48 GiB весов) не оставлял бы запас под KV.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
    ...
    recommended: [
      {
        ...
        quant: 'fp8',
        estimatedVramGiB: 40,
        notes: 'FP8 на 48 GB для agent coding; BF16 лучше на A100 80GB.',
      },
      {
        gpuFamily: 'A100',
        gpuCount: 1,
