...
- НЕ цена мастера: 0 ₽ «фиксированная плата», unit «Ресурсы мастера · vCPU/RAM» по отдельности. Yandex: 2/8 (s-c2-m8, минимум в консоли) + паритет 2/6; формы 2/4 у Yandex нет. VK: 2/6 (дефолт) · 2/8 · паритет 2/4.
