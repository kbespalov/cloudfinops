      ...
      parameters: {
        ...
        properties: {
          ...
          aiModel: {
            type: 'string',
            description:
              'Точное имя модели из запроса: «gpt-oss-120b», «Qwen 3.6», «GLM 5.2». Не подменяй аналогом и не пиши голое «120B»/«80B». Варианты написания (gpt oss 120b) ок. Без версии («Qwen») — шире.',
          },
          storageClass: {
            type: 'string',
