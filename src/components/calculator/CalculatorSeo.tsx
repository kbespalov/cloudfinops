  ...
  return (
    <section className={styles.seo} aria-labelledby="calculator-lakehouse-seo-title">
      ...
      <ul className={styles.list}>
        ...
        <li>
          <strong>Medium (~75 TiB)</strong> — production-команда, HA master, регулярный ETL и SQL в
          рабочее время.
        </li>
        <li>
...
const LAKEHOUSE_FAQ = [
  ...
  },
  {
    ...
    answer:
      'Снизьте duty-cycle ETL/SQL, увеличьте долю cold для архива, проверьте, нужен ли HA master, и не держите query-пул always-on при редких запросах. Для ad hoc часто выгоднее serverless SQL — обсудите с AI-ассистентом на странице.',
  },
  {
